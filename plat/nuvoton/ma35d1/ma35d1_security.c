...
static void init_tzc400(void)
{
	...
	unsigned long long ddr_s_size = MA35D1_DDR_MAX_SIZE - MA35D1_DRAM_SIZE - 0x100000;
	...
	tzc400_configure_region(MA35D1_TZC2_FILTER, 1,
				MA35D1_DRAM_S_BASE,
				MA35D1_DRAM_S_BASE +
				(ddr_s_size - 1U),
				TZC_REGION_S_RDWR,
	...
	/* Region 1 set to cover Secure DRAM at 0x8f80_0000 */
	tzc400_configure_region(MA35D1_TZC0_FILTER, 1,
				MA35D1_DRAM_S_BASE,
				MA35D1_DRAM_S_BASE +
				(ddr_s_size - 1U),
				TZC_REGION_S_RDWR,
