...
static int ma35d0_pll_find_closest(unsigned long rate, unsigned long parent_rate,
...
static void ma35d0_clock_setup(void)
{
	...
	if ((pllmode[3] == 0) || (pllmode[3] == 1)) {
		if (ma35d0_pll_find_closest(pllfreq[3], 24000000, pllmode[3], reg_ctl, &freq) == 0) {
	...
	if ((pllmode[5] == 0) || (pllmode[5] == 1)) {
		if (ma35d0_pll_find_closest(pllfreq[5], 24000000, pllmode[5], reg_ctl, &freq) == 0) {
